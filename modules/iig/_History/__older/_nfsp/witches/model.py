...
class DQNBase(nn.Module):
    ...
    def __init__(self, env):
        ...
        self.input_shape = env.observation_space.n
        ...
        self.features = nn.Sequential(
            ...
            nn.Linear(32, 32),
            nn.ReLU(),
            nn.Linear(32, self.input_shape),
            nn.ReLU()
        )


        # self.features = nn.Sequential(
        #     nn.Conv2d(self.input_shape, 8, kernel_size=4, stride=2),
        #     cReLU(),
    ...
    def _feature_size(self):
        return self.input_shape    #self.features(torch.zeros(1, *(self.input_shape,))).view(1, -1).size(1)
