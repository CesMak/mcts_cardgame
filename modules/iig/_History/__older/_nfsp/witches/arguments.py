...
def get_args():
    ...
    parser.add_argument('--train-freq', type=int, default=200,#was 1 before
                        help='Number of steps between optimization step')
    parser.add_argument('--gamma', type=float, default=0.99,
                        help='Discount factor')
    parser.add_argument('--eta', type=float, default=0.1,
                        help='Anticipatory (Vorausschauender) Parameter for NFSP')
    ...
    parser.add_argument('--env', type=str, default='Witches_multi-v2',
