...
def test_with_random(policy, env, jjj, max_corr, episodes=5000, print_game=30):
...
def learn_single(ppo, update_timestep, eps_decay, env, increase_batch, max_reward=-5.0):
    memory          = Memory()
...
def testNotLearned():
    ...
    ppo.policy.load_state_dict(torch.load("PPO_noLSTM_14480000_-0.7211500590783773_2539_-49.5862.pth"))
...
if __name__ == '__main__':
    ...
    ## Setup Env:
    train_path    ="PPO_noLSTM_26160000_-1.0977205571971296_4738_-6.2802.pth"
